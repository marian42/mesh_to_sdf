...
def mesh_to_sdf(mesh, query_points, surface_point_method='scan', sign_method='normal', bounding_radius=None, scan_resolution=400, sample_point_count=10000000, normal_sample_count=11):
    ...
    point_cloud = get_surface_point_cloud(mesh, surface_point_method, bounding_radius, scan_resolution, sample_point_count, calculate_normals=sign_method=='normal')
