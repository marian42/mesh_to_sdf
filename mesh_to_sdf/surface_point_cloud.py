...
class SurfacePointCloud:
    ...
    def sample_sdf_near_surface(self, number_of_points=500000, use_scans=True, sign_method='normal', normal_sample_count=11, min_size=0, return_gradients=False, uniform_proportion=0.06, jitter=0.0025):
        query_points = []
